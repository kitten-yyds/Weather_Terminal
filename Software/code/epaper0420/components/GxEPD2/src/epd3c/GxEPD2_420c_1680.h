...
#ifndef _GxEPD2_420c_1680_H_
#define _GxEPD2_420c_1680_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_420c_1680 : public GxEPD2_EPD
{
  public:
    // attributes
...
//    static const bool usePartialUpdateWindow = false; // needs be false to work
    ...
    static const uint16_t power_on_time = 100; // ms, e.g. 38006us
    static const uint16_t power_off_time = 150; // ms, e.g. 20292us
    static const uint16_t full_refresh_time = 27000; // ms, e.g. 15771891us
    static const uint16_t partial_refresh_time = 27000; // ms, e.g. 15771891us
    // constructor
    GxEPD2_420c_1680(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
